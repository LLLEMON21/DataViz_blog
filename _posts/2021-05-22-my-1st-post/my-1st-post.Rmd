...
### 4.1.1	Remove unnecessary rows and columns for sheet T1
...
### 4.1.2 Do the same steps for sheet T2
### 4.1.3 Combine sheets T1 and T2 
...
### 4.1.5	Rename headers and change data type for columns
...
### 4.2.1 Create line chart
### (1) Drag [Country] and [Trade Volume] to Columns and Rows respectively.
![](image/(1).png){width=70%}

*Figure 7: Create line chart*

### (2) Sort by Trade Volume and Update view from ‘Standard’ to ‘Entire View’.
### (3) Add reference line for Trade Volume
...
### (4)	Format reference line
Change the font color to red and use currency format for numbers.
![](image/(4).png){width=50%}
*Figure 9: Format for reference line*

### (5)	Drag <Trade Volume> to Label, and format labels with bigger size and bold font, also in custom currency format without decimals.
![](image/(5).png){width=50%}
*Figure 10: Add label*

### (6) Hide field labels ‘Country’ for columns
### (7) Drag <Date> to color and choose color blue for year 2019 and color orange for year 2020
### (8) Rename the chart title as ‘Trade Volumn of Top 6 Countries by Year 2019 & 2020’

### 4.2.2 Create line chart

### (1) Analysis - Create calculated field for ‘Import’
![](image/Analysis.png){width=50%}
*Figure 11: Create calculated field*

### (2)	Same step for creating field ‘Export’
### (3) Drag [Country] and [Import], [Export] to Rows and Columns, respectively.

![](image/same_step.png){width=50%}
*Figure 12: Choose variables*

### (4) Edit Axis for <Import>, reversed the scale
![](image/axis.png){width=50%}
*Figure 13: Edit axis*


### (5)	Sort for Import in descending order
...
### (7) Drag <Date> to color for SUM(Import) and SUM(Export) respectively, and choose color blue for year 2019 and color orange for year 2020
### (8)	Drag <Import> to label, bigger the font size, change to white color and bold as well; format the numbers to percentage without decimals.
...
### (9) Update view from ‘Standard’ to ‘Fit Width’.
### (10)	Rename the chart title as  ‘Proportion of Trade Volume by Year 2019 & 2020’

### 4.2.3 Create dashboard
...
###	5.2.1 In year 2019 and 2020. Mainland China has the highest trade volume among the top six trading countries, followed by Malaysia. The figure of the US also beyond average benchmark. Other countries, i.e. Taiwan, Hong Kong and Japan are below benchmark regarding to the total trading volume over two years.
###	5.2.2 Looking into year 2019 and 2020 separately, Mainland China still remain the top  1 place for total trading volume. The rank remain stable for other countries as well.
###	5.2.3 The rank of import volume for six countries is similar to the rank of total trading volume, except for Japan, which figure exceeded Hong Kong. 
###	5.2.4 There are some changes of rank for six countries with regard to export volume, Mainland China still remain the top 1, which followed by Hong Kong, Malaysia, United States, Japan and Taiwan.
###	5.2.5 Mainland China had the undisputed strength towards overall trading performance, while Hong Kong had the smallest figure for import volume but surprisingly performed good at export performance.
###	5.2.6 The proportion of export and import is similar for all 6 countries from 2019 to 2020. Mainland China, Japan and Hong Kong remain exactly the same. The percentage of export for Malaysia increased 2%; the US’s import dropped 3% and export dropped 2%; the import proportion of Taiwan increased 1%.